...
urlpatterns = [
    ...
    path("search/export-csv/", views.export_selected_search_csv_view, name="export_selected_search_csv"),
    ...
    path("data-list/export-csv/", views.export_selected_my_data_csv_view, name="export_selected_my_data_csv"),
    ...
    path("data-list/<int:pk>/curves.csv", views.mechanical_csv_export_view, name="mechanical_csv_export"),
